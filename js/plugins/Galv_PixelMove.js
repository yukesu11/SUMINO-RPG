...
//  Galv_PixelMove.js
//-----------------------------------------------------------------------------
//  2021-12-31 - Version 1.4 - bug found by McKathlin in autotile function
//  2020-09-12 - Version 1.3 - tried to fix event jittering, hopefully worked
...
//-----------------------------------------------------------------------------
/*:
 * @plugindesc (v.1.4) Gives the illusion of pixel movement for the player.
 * 
...
Game_Map.prototype.autotileType = function(x, y, z) {
	x = Math.round(x);
	y = Math.round(y);
	return Galv.PMOVE.Game_Map_autotileType.call(this,x,y,z);
};
...
Galv.PMOVE.Game_CharacterBase_distancePerFrame = Game_CharacterBase.prototype.distancePerFrame;
Game_CharacterBase.prototype.distancePerFrame = function() {
	return Galv.PMOVE.Game_CharacterBase_distancePerFrame.call(this) * (this._diagDir ? Galv.PMOVE.diagMod : 1);
};
...
// Fix for event jittering?? Overwrites
